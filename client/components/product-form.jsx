      ...
      <div className='container modalContainer'>
        ...
        <form id="myForm" name="myForm" encType="multipart/form-data" onSubmit={this.handleSubmit}>
          <div className="form-inline justify-content-center mb-5">
            ...
            <input value={this.state.title} onChange={this.onTitleChange} type="text" name="title" className="form-control" placeholder="Enter Title"></input>
          </div>
          <div className="form-inline justify-content-center mb-5">
            <label className="mr-5 formTextSize" htmlFor="formGroupExampleInput2">Price</label>
            <input value={this.state.price} onChange={this.onPriceChange} type="text" name="price" className="form-control" id="formGroupExampleInput2" placeholder="$0.00"></input>
          </div>
          <div className="form-inline justify-content-center mb-5">
            <label className="mr-5 formTextSize" htmlFor="formGroupExampleInput2">Description</label>
            <input value={this.state.description} onChange={this.onDescriptionChange} type="text" name="description" className="form-control" id="formGroupExampleInput2" placeholder="Enter Description"></input>
          </div>
